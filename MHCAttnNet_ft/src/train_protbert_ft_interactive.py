...
def train():
    ...
    base_path= '/scratch/ssd004/scratch/vchu/PEPMHC/output/pep/lr_e_5/mlm_0.15/max_len_{}/500_epochs/'.format(args.pep_max_len)

    model_name1 = base_path + 'checkpoint-96000'
    ...
    save_path = "/scratch/ssd004/scratch/vchu/PEPMHC/output/pep_mhc/mlm_0.15_max_len_{}_mhc_350/".format(args.pep_max_len)
    make_dir(save_path)
